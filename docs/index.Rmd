...
##### Results 
The boxplot shows that there is a general negative trend in number of SIMD to prescriptions per person. This data aligns with our initial argument that living standards could be affecting chronic asthma. 
...
#gp_simd_datazones <- left_join(datazones_2011, simd_prescriptions_gp_join)
