...
This exploratory data analysis will investigate whether living standards could have an impact on the prevalence of chronic asthma. To do this, living standards will be defined by SIMD due to the association of social housing with mold and poor ventilation, and prevalence of chronic asthma will be measured by the number of prescriptions of drugs used in common preventer inhalers as these are often prescribed when long or short acting bronchodilators are ineffective, suggesting severe chronic asthma.
