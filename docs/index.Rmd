...
Asthma is a common condition worldwide that can be caused by prolonged indoor exposure to mold (World Health Organization, 2024; Mousavi, 2016). Currently, there is a lack of accurate data on the prevalence of mold in social housing, potentially making this association more serious than expected (The Scottish Parliament, 2023).

This exploratory data analysis will investigate whether living standards could have an impact on the prevalence of chronic asthma. To do this, living standards will be defined by SIMD due to the association of social housing with mold, and prevalence of chronic asthma will be measured by the number of prescriptions of drugs used in common preventer inhalers as these are often prescribed when long or short acting bronchodilators are ineffective, suggesting severe chronic asthma.
